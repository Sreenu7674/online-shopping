...
public class ProductTestCase {
	...
	public  void testCRUDProduct() {
		...
		assertEquals("Something went worng while inserting a new products",
		...
		assertEquals("Something went worng while updating the existing record",
				true,productDAO.update(product));
		
		assertEquals("Something went worng while deleting the existing record",
				true,productDAO.delete(product));
		
		///list
		assertEquals("Something went worng while fetching the list of products",
